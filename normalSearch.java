...
public class normalSearch extends JFrame implements ActionListener{
    JTable table;
    ...
    normalSearch(){
        setLayout(null);
        JLabel heading= new JLabel("NORMAL TICKET BOOKING DETAILS");
        ...
        try{
            adcon ad=new adcon();
            ResultSet rs= ad.s.executeQuery("select * from normals");
    ...
    public void actionPerformed(ActionEvent ae){
            if (ae.getSource()==se) {
            String query="select * from normals where b_id ='"+c.getSelectedItem()+"'";
            try{
                adcon ad=new adcon();
